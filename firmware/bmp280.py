...
class BMP280:
    ...
    @property
    def altitude(self):
        # Local sea-level pressure in Hectopascals (hPa). Update this based on local weather!
        sea_level_pressure = 1012.87 
        
        # Convert sensor pressure from Pascals (Pa) to Hectopascals (hPa)
        ...
        return 44330.0 * (1.0 - (p_hpa / sea_level_pressure) ** (1.0 / 5.255))
